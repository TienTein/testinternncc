...
const HomePage = () => {
  ...
  return (
    <div
      className={`Home px-[50px] xl:px-[100px] lg:px-[50px] ${
        isMatchMD ? "mt-[10vh]" : "ml-[10vw]"
      }`}
    >
      ...
      <div className="bg-[#EFEFEF] text-center mb-[50px] py-[20px] xl:py-[50px] px-[20px] xl:px-[100px] lg:px-[50px]">
